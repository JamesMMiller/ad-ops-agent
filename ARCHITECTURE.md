...
| Store hello@ + inbox triage bot | `shared/skills/store-inbox/` (deal JSON: `/pages/inbox-deal`) |
...
| `shared/skills/store-inbox/SKILL.md` | hello@ + Gmail LLM triage; deal bodies endpoint `/pages/inbox-deal` |
