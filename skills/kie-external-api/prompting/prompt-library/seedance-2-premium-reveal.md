...
### Resolution note
- Square (`1:1`) for Meta feed (Instagram + Facebook) — product centered with equal black void on all sides
- Vertical (`9:16`) only when the placement is Stories/Reels-only
